...
public class E2E_Tests {
    ...
    public static void main(String[] args) {
        String userID = "a6109d3c-7814-4cb8-8528-a3f37f789dbc";
        String userName = "britest03";
        String password = "Britest@03";
        ...
        Assert.assertEquals(/*204*/400, response.getStatusCode());
